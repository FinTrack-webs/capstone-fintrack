...
import { accountTypes, apiTransactionTypes, paymentMethods } from "@/constants/mock-data";
    ...
    <form onSubmit={handleSubmit} className="space-y-7">
      ...
      <div className="grid gap-7 lg:grid-cols-2">
        <Card>
          ...
          <select className="mt-4 h-14 w-full rounded-full border border-outline-soft/40 bg-surface-low px-5 text-sm font-semibold outline-none dark:bg-white/10">
